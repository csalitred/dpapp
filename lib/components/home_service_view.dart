...
import 'package:dpapp/models/service.dart';
...
class HomeServiceView extends StatelessWidget {
  ...
  Container _buildContainer(int index, BuildContext context, Service service) {
    ...
    switch (index) {
      case 0:
        borderRaidus = const BorderRadius.only(topLeft: Radius.circular(15.0));
        break;
      case 1:
        borderRaidus = const BorderRadius.only(topRight: Radius.circular(15.0));
        break;
      case 2:
        borderRaidus = const BorderRadius.only(bottomLeft: Radius.circular(15.0));
        break;
      default:
        borderRaidus = const BorderRadius.only(bottomRight: Radius.circular(15.0));
    }
